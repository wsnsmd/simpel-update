        ...
        <ul class="nav-main">
            ...
            <li class="nav-main-item">
                <a class="nav-main-link"
                    href="{{ route('backend.diklat.jadwal.detail', ['jadwal' => $jadwal->id, 'slug' => str_slug($jadwal->nama)]) }}">
            ...
            <li class="nav-main-item">
                <a class="nav-main-link"
                    href="{{ route('backend.diklat.jadwal.detail', ['jadwal' => $jadwal->id, 'slug' => str_slug($jadwal->nama), 'page' => 'mata-pelatihan']) }}">
            ...
            <li class="nav-main-item">
                <a class="nav-main-link"
                    href="{{ route('backend.diklat.jadwal.detail', ['jadwal' => $jadwal->id, 'slug' => str_slug($jadwal->nama), 'page' => 'seminar']) }}">
            ...
            <li class="nav-main-item">
                <a class="nav-main-link"
                    href="{{ route('backend.diklat.jadwal.detail', ['jadwal' => $jadwal->id, 'slug' => str_slug($jadwal->nama), 'page' => 'surat-tugas']) }}">
            ...
            <li class="nav-main-item">
                <a class="nav-main-link"
                    href="{{ route('backend.diklat.jadwal.detail', ['jadwal' => $jadwal->id, 'slug' => str_slug($jadwal->nama), 'page' => 'survei']) }}">
                    <i class="nav-main-link-icon fa fa-chart-bar"></i>
                    <span class="nav-main-link-name">Survei</span>
                </a>
            </li>
            <li class="nav-main-item">
                <a class="nav-main-link"
                    href="{{ route('backend.diklat.jadwal.detail', ['jadwal' => $jadwal->id, 'slug' => str_slug($jadwal->nama), 'page' => 'cetak']) }}">
            ...
            <li class="nav-main-item">
                <a class="nav-main-link"
                    href="{{ route('backend.diklat.jadwal.detail', ['jadwal' => $jadwal->id, 'slug' => str_slug($jadwal->nama), 'page' => 'checklist']) }}">
