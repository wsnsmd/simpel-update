                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-right p-0" aria-labelledby="page-header-user-dropdown">
                            ...
                            <div class="p-2">
                                ...
                                <a class="dropdown-item" href="{{ route('authentik.logout') }}" onclick="event.preventDefault();
                                        document.getElementById('logout-form').submit();">
                                    <i class="far fa-fw fa-arrow-alt-circle-left mr-1"></i> Logout
                                </a>

                                <form id="logout-form" action="{{ route('authentik.logout') }}" method="GET"
                                    style="display: none;">
                                    @csrf
                                </form>
                            </div>
            ...
            <div class="content py-0">
                <div class="row font-size-sm">
                    <div class="col-sm-6 order-sm-1 text-center text-sm-left">
                        <a class="font-w600" href="https://bpsdm.kaltimprov.go.id/" target="_blank">BPSDM Prov.
                            Kaltim</a> &copy; <span data-toggle="year-copy">2019</span>.
                    </div>
                </div>
            </div>
        </footer>
