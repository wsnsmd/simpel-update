                                ...
                                <div class="col-md-6 col-xl-4">
                                    <div class="mb-3 text-center">
                                        <a class="img-link" href="{{ route('index') }}">
                                            <img class="" src="{{ asset('media/images/bpsdm-logo.png') }}"
                                                alt="BPSDM Kaltim" height="80px">
                                        </a>
                                                ...
                                                <div class="mb-3">
                                                    <form action="{{ route('jadwal.daftar') }}" method="POST">
                                                        ...
                                                        <input type="hidden" id="jadwal_id" name="jadwal_id"
                                                            value="{{$jadwal->id}}">
                                                        <button type="submit"
                                                            class="btn w-100 btn-lg btn-hero btn-primary rounded-pill">{{ $t->title }}</button>
                                                    </form>
                                                </div>
                                            @else
                                                <div class="mb-3">
                                                    <a href="{!! $t->url !!}"
                                                        class="btn w-100 btn-lg btn-hero btn-primary rounded-pill"
                                        ...
                                        <div class="mb-3">
                                            <form action="{{ route('jadwal.daftar') }}" method="POST">
                                                ...
                                                <input type="hidden" id="jadwal_id" name="jadwal_id"
                                                    value="{{$jadwal->id}}">
                                                <button type="submit"
                                                    class="btn w-100 btn-lg btn-hero btn-primary rounded-pill">Daftar</button>
                                            </form>
                                        </div>
                                        <div class="mb-3">
