        ...
        <div class="bg-white-90">
            <div class="content invisible" data-toggle="appear">
                <div class="text-center py-3">
                    <h1 class="h3 font-w700 mb-2">{{ isset($jadwal) ? $jadwal->nama : 'Pencarian Data' }}</h1>
                    <h2 class="h5 font-w400 text-muted">{{ isset($jadwal) ? $jadwal->kelas : '' }}</h2>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white">
        <div class="content">
            <div class="row invisible" data-toggle="appear">
                {{-- Jika tidak ada jadwal, buat kolom konten menjadi full width (col-md-12) --}}
                <div class="{{ isset($jadwal) ? 'col-md-9' : 'col-md-12' }}">
                    <div class="block block-rounded block-bordered mb-3">
                        @yield('content-block')
                    </div>
                </div>

                {{-- Sidebar hanya tampil jika variabel $jadwal tersedia --}}
                @isset($jadwal)
                    <div class="col-md-3 px-0">
                        <div class="block block-rounded block-bordered mb-3">
                            <div class="block-header block-header-default">
                                <h3 class="block-title font-size-sm">Informasi</h3>
                            </div>
                        ...
                        <div class="block block-rounded block-bordered">
                            <div class="block-header block-header-default">
                                <h3 class="block-title font-size-sm">Kontak</h3>
                            </div>
                            <div class="block-content">
