        ...
        <div class="block-content block-content-full">
            ...
            <div class="form-group mb-0">
                ...
                <div class="fileinput fileinput-new" data-provides="fileinput">
                    ...
                    <div>
                        <span class="btn btn-sm btn-outline-secondary btn-file"><span class="fileinput-new">Pilih
                                Foto</span><span class="fileinput-exists">Ganti</span><input type="file"
            ...
            <div class="form-group form-row">
                <div class="col-6">
                    ...
                    <input class="js-maxlength form-control" type="text" id="nip" name="nip"
                        placeholder="NIP tanpa spasi..." minlength="18" maxlength="18" data-always-show="true"
                        data-warning-class="badge badge-primary" data-limit-reached-class="badge badge-primary"
                        value="{{ $pegawai['nip'] }}" readonly required>
                </div>
                <div class="col-6">
                    <label for="nip">NIK (No. KTP)</label>
                    <input class="js-maxlength form-control" type="text" id="ktp" name="ktp" placeholder="NIK (No. KTP)..."
                        minlength="16" maxlength="16" data-always-show="true" data-warning-class="badge badge-primary"
                        data-limit-reached-class="badge badge-primary" value="{{ old('ktp') }}" required>
                </div>
            </div>
            <div class="form-group form-row">
                <div class="col-6">
                ...
                <div class="col-6">
                    ...
                    <input class="form-control" type="text" id="nama_panggil" name="nama_panggil"
                        placeholder="Nama Panggilan..." value="{{ old('nama_panggil') }}" required>
                </div>
            </div>
            ...
            <div class="form-group form-row">
                <div class="col-6">
                    ...
                    <input class="form-control" type="text" id="tmp_lahir" name="tmp_lahir" placeholder="Tempat Lahir..."
                        value="{{ old('tmp_lahir') }}" required>
                </div>
                <div class="col-6">
                    <label for="instansi">Tanggal Lahir</label>
                    <input class="js-datepicker form-control" type="text" id="tgl_lahir" name="tgl_lahir"
                        placeholder="Tanggal Lahir" data-week-start="1" data-autoclose="true" data-today-highlight="true"
                        data-date-format="yyyy-mm-dd" value="{{ old('tgl_lahir') }}" required>
                </div>
            </div>
            <div class="form-group form-row">
                <div class="col-6">
                ...
                <div class="col-6">
                    ...
                    <select class="form-control" id="pangkat" name="pangkat" style="width: 100%;" required>
                        ...
                        @foreach ($pangkat as $p)
                            <option value="{{ $p->id }}" {{ old('pangkat') == $p->id ? "selected" : "" }}>{{ $p->singkat }}
                            </option>
                        @endforeach
                    </select>
                </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" id="satker_nama" name="satker_nama" placeholder="Satuan Kerja..."
                    value="{{ old('satker_nama') }}" required>
            </div>
            <div class="form-group">
                <label for="instansi">Alamat</label>
                <textarea class="form-control" id="satker_alamat" name="satker_alamat" placeholder="Alamat Satuan Kerja..."
                    required>{{ old('satker_alamat') }}</textarea>
            </div>
            <div class="form-group form-row">
                <div class="col-6">
                    <label for="instansi">No. Telepon</label>
                    <input class="form-control" type="text" id="satker_telp" name="satker_telp"
                        placeholder="No. Telepon Satuan Kerja" value="{{ old('satker_telp') }}" required>
                </div>
            </div>
        </div>
