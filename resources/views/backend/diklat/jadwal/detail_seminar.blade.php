            ...
            <div class="row row-deck">
                <div class="col-6 col-md-4 col-xl-2">
                    <a class="block block-rounded block-link-pop text-center d-flex align-items-center"
                        href="{{ route('backend.diklat.seminar.kelompok.create', ['jadwal' => $jadwal->id, 'slug' => str_slug($jadwal->nama)]) }}">
                            ...
                            @foreach ($seminar as $s)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form action="{{ route('backend.diklat.seminar.kelompok.destroy', $s->id) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <div class="btn-group">
                                                <a href="{{ route('backend.diklat.seminar.anggota.index', ['kelompok' => $s->id]) }}"
                                                    class="btn btn-sm btn-success" title="Anggota" data-toggle="tooltip"
                                                    data-placement="top">
                                                    <i class="fa fa-users"></i>
                                                </a>
                                                <a href="#" onclick="showCetak({{$s->id}})" class="btn btn-sm btn-warning"
                                                    title="Cetak Form" data-toggle="tooltip" data-placement="top">
                                                    <i class="fa fa-print"></i>
                                                </a>
                                                <a href="{{ route('backend.diklat.seminar.kelompok.edit', ['jadwal' => $jadwal->id, 'slug' => str_slug($jadwal->nama), 'id' => $s->id]) }}"
                                                    class="btn btn-sm btn-primary" title="Edit" data-toggle="tooltip"
                                                    data-placement="top">
                                                    <i class="fa fa-pencil-alt"></i>
                                                </a>
                                                <a href="javascript:;" onclick="return showAlert($(this).closest('form'));"
                                                    class="btn btn-sm btn-danger" title="Hapus" data-toggle="tooltip"
                                                    data-placement="top">
                        ...
                        <div class="block block-themed block-transparent mb-0">
                            ...
                            <div class="block-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="js-datepicker form-control" type="text" id="tanggal" name="tanggal"
                                        placeholder="YYYY-MM-DD" data-week-start="1" data-autoclose="true"
                                        data-today-highlight="true" data-date-format="yyyy-mm-dd" value="" required>
                                </div>
                            </div>
