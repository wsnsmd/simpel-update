    ...
    @if(Gate::check('isCreator', $jadwal) || (Gate::check('isKontribusi') && $jadwal->status_jadwal < 3))
        <div class="pt-4 px-4 bg-body-dark rounded push">
            <div class="row row-deck">
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <a class="block block-rounded block-link-pop text-center d-flex align-items-center" href="javascript:;"
                        onclick="event.preventDefault(); document.getElementById('rekap-form').submit();">
                        <div class="block-content">
                            <p class="mb-2 d-sm-block">
                    ...
                    <form id="rekap-form" action="{{ route('backend.diklat.mapel.wi.rekap', ['jadwal' => $jadwal->id]) }}"
                        method="post" style="display: none;" target="_cetak">
                        @csrf
                    </form>
                </div>
            </div>
    ...
    <div class="content">
                            ...
                            @foreach ($mapel as $m)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a href="{{ route('backend.diklat.mapel.jadwal', ['jadwal' => $jadwal->id, 'slug' => str_slug($jadwal->nama), 'id' => $m->id]) }}"
                                                class="btn btn-sm btn-outline-primary" title="Jadwal">
        ...
        <div class="modal fade" id="mdl-tt" tabindex="-1" role="dialog" aria-labelledby="mdl-tt" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-popin" role="document">
                <form id="mdl-tt-form" method="POST"
                    action="{{ route('backend.diklat.mapel.tt.update', ['jadwal' => $jadwal->id]) }}" autocomplete="off">
                    @csrf
                        ...
                        <div class="block block-themed block-transparent mb-0">
                            ...
                            <div class="block-content" id="mdl-form-content">
                                <div class="form-group form-row">
                                    <div class="col-6">
                                        <label for="tempat" class="control-label">Tempat <span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="tempat" name="tempat"
                                            placeholder="Cth. Samarinda..." required>
                                    </div>
                                    <div class="col-6">
                                        <label for="tanggal" class="control-label">Tanggal<span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="form-group form-row">
                                    <div class="col-6">
                                        <label for="import" class="control-label">a.n. Kepala <span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="form-group form-row">
                                    ...
                                    <div class="col-6">
                                        <label for="pangkat" class="control-label">Pangkat / Gol. Ruang <span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="form-group form-row">
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="form-control" id="paraf1_nama" name="paraf1_nama"
                                            placeholder="Nama...">
                                    </div>
                                    <div class="col-6">
                                        <label for="nip" class="control-label">Paraf-1 Jabatan</label>
                                        <input type="text" class="form-control" id="paraf1_jabatan" name="paraf1_jabatan"
                                            placeholder="Jabatan...">
                                    </div>
                                </div>
                                <div class="form-group form-row">
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="form-control" id="paraf2_nama" name="paraf2_nama"
                                            placeholder="Nama...">
                                    </div>
                                    <div class="col-6">
                                        <label for="pangkat" class="control-label">Paraf-2 Jabatan</label>
                                        <input type="text" class="form-control" id="paraf2_jabatan" name="paraf2_jabatan"
                                            placeholder="Jabatan...">
                                    </div>
                                </div>
                            </div>
