    ...
    <div class="content">
        ...
        <div class="pt-4 px-4 bg-body-dark rounded push">
            <div class="row row-deck">
                <div class="col-6 col-md-4 col-xl-2">
                    <a class="block block-rounded block-link-pop text-center d-flex align-items-center" href="{{ route('backend.diklat.kurikulum.create') }}">
        ...
        <div class="block block-rounded block-bordered block-fx-shadow block-themed">
            <div class="block-header">
                <h3 class="block-title">Kurikulum</h3>
            </div>
                ...
                <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="font-w600">
                                {{ getJenisPembelajaran($k->jenis_belajar) }}
                            </td>          
                            <td class="font-w600">
                                {{ $k->total_jp }}
                            </td>                                                             
                            <td class="text-center">
                                <form action="{{ route('backend.diklat.kurikulum.destroy', $k->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <div class="btn-group">
                                        <a href="{{ route('backend.diklat.kurikulum.detail', ['kurikulum' => $k->id, 'slug' => str_slug($k->nama)]) }}" class="btn btn-sm btn-success" title="Detail">
                                            <i class="fa fa-cog"></i>
                                        </a>
                                        <a href="{{ route('backend.diklat.kurikulum.edit', $k->id) }}" class="btn btn-sm btn-primary" title="Edit">
