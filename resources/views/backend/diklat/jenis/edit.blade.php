            ...
            <div class="block-content block-content-full">
                <form class="mb-2" action="{{ route('backend.diklat.jenis.update', $jenis->id) }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control{{ $errors->has('id') ? ' is-invalid' : '' }}" id="id" name="id" placeholder="ID..." value="{{ $jenis->id }}">
                            @if ($errors->has('id'))
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="aktif" name="aktif" style="width: 100%;" data-placeholder="-- Pilih aktif --" required>
                                ...
                                <option value="0" {{ $jenis->aktif == 0 ? 'selected' : ''}}>Tidak</option>
                                <option value="1" {{ $jenis->aktif == 1 ? 'selected' : ''}}>Ya</option>
                            </select>
                            @if ($errors->has('aktif'))
