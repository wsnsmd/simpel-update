...
@section('content')
    <!-- Hero -->
    @include('backend.diklat.jenis.hero')
    <!-- END Hero -->
    ...
    <div class="content">
        ...
        <div class="block block-rounded block-bordered block-fx-shadow block-themed">
            <div class="block-header block-header-default">
                <h3 class="block-title">Kompetensi - Tambah Data</h3>
            </div>
            <div class="block-content block-content-full">
                <form class="mb-2" action="{{ route('backend.diklat.jenis.store') }}" method="POST" autocomplete="off">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control{{ $errors->has('nama') ? ' is-invalid' : '' }}" id="nama" name="nama" placeholder="Kompetensi..." value="{{ old('nama') }}">
                            @if ($errors->has('nama'))
