...
<div class="form-group">
    <label for="cetak_mapel" class="control-label">Mata Pelatihan / Materi <span class="text-danger">*</span></label>
    <input type="text" class="form-control" id="cetak_mapel" name="cetak_mapel" placeholder="Mata Pelatihan..." required>
</div>
<div class="form-group">
    <label for="cetak_fator" class="control-label">Fasilitator / Narasumber <span class="text-danger">*</span></label>
    <input type="text" class="form-control" id="cetak_fator" name="cetak_fator" placeholder="Fasilitator..." required>
</div>
<div class="form-group">
    <label for="cetak_toc" class="control-label">Pengelola Kelas<span class="text-danger">*</span></label>
    <input type="text" class="form-control" id="cetak_toc" name="cetak_toc" placeholder="Pengelola Kelas..." required>
</div>
