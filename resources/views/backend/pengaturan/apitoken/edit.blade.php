    ...
    <div class="content">
        ...
        <div class="block block-rounded block-bordered block-fx-shadow block-themed">
            ...
            <div class="block-content block-content-full border-top">
                <form class="mb-2" action="{{ route('backend.apitoken.update', $apiToken->id) }}" method="POST" autocomplete="off">
                    @csrf
                    @method('PATCH')
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label text-right" for="nama">Nama Aplikasi <span class="text-danger">*</span></label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control{{ $errors->has('nama') ? ' is-invalid' : '' }}" id="nama" name="nama" placeholder="Nama Aplikasi..." value="{{ $apiToken->app_name}}" required>
                            @if ($errors->has('nama'))
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control{{ $errors->has('ip_address') ? ' is-invalid' : '' }}" id="ip_address" name="ip_address" placeholder="IP Address..." value="{{ $apiToken->ip_address }}">
