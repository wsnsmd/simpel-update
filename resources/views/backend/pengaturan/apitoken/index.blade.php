    ...
    <div class="content">
        ...
        <div class="pt-4 px-4 bg-body-dark rounded push">
            <div class="row row-deck">
                <div class="col-6 col-md-4 col-xl-2">
                    <a class="block block-rounded block-link-pop text-center d-flex align-items-center" href="{{ route('backend.apitoken.create') }}">
        ...
        <div class="block block-rounded block-bordered block-fx-shadow block-themed">
            <div class="block-header">
                <h3 class="block-title">API Token</h3>
            </div>
            <div class="block-content block-content-full border-top">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-vcenter js-dataTable-full" style="width:100%">
                        ...
                        <tbody>
                            @foreach ($apitoken as $at)
                            <tr>
                                <td class="text-center">{{ $loop->iteration }}</td>
                                <td class="font-w600">{{ $at->app_name }}</td>
                                ...
                                <td class="text-center">
                                    ...
                                    <form action="{{ route('backend.apitoken.destroy', $at->id) }}" method="POST">
                                        ...
                                        @method('DELETE')
                                        <div class="btn-group">
                                            <a href="{{ route('backend.apitoken.edit', $at->id) }}" class="btn btn-sm btn-primary" title="Edit">
