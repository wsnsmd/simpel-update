    ...
    <div class="content">
        ...
        <div class="pt-4 px-4 bg-body-dark rounded push">
            <div class="row row-deck">
                <div class="col-6 col-md-4 col-xl-2">
                    <a class="block block-rounded block-link-pop text-center d-flex align-items-center" href="{{ route('backend.master.pangkat.create') }}">
        ...
        <div class="block block-rounded block-bordered block-fx-shadow block-themed">
            <div class="block-header">
                <h3 class="block-title">Pangkat</h3>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <form action="{{ route('backend.master.pangkat.destroy', $p->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <div class="btn-group">                                    
                                        <a href="{{ route('backend.master.pangkat.edit', $p->id) }}" class="btn btn-sm btn-primary" title="Edit">
