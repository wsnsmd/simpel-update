    ...
    <div class="content">
        ...
        <div class="block block-rounded block-bordered block-fx-shadow block-themed">
            <div class="block-header block-header-default">
                <h3 class="block-title">Pangkat - Tambah Data</h3>
            </div>
            <div class="block-content block-content-full">
                <form class="mb-2" action="{{ route('backend.master.pangkat.store') }}" method="POST" autocomplete="off">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control{{ $errors->has('pangkat') ? ' is-invalid' : '' }}" id="pangkat" name="pangkat" placeholder="Pangkat..." value="{{ old('pangkat') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control{{ $errors->has('golongan') ? ' is-invalid' : '' }}" id="golongan" name="golongan" placeholder="Golongan..." value="{{ old('golongan') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control{{ $errors->has('singkat') ? ' is-invalid' : '' }}" id="singkat" name="singkat" placeholder="Pangkat..." value="{{ old('singkat') }}">
