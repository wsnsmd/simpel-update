...
@section('content')
    ...
    <!-- Page Content -->
    <div class="content">
        {{ Request::url() === route('backend.master.agama.create') }}
        <!-- Quick Menu -->
        <div class="pt-4 px-4 bg-body-dark rounded push">
            <div class="row row-deck">
                <div class="col-6 col-md-4 col-xl-2">
                    <a class="block block-rounded block-link-pop text-center d-flex align-items-center" href="{{ route('backend.master.agama.create') }}">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <form action="{{ route('backend.master.agama.destroy', $a->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <div class="btn-group">                                    
                                            <a href="{{ route('backend.master.agama.edit', $a->id) }}" class="btn btn-sm btn-primary" title="Edit">
