...
<head>
    ...
    <script type="text/javascript">   
		...
		Stimulsoft.Base.Localization.StiLocalization.setLocalizationFile("{{ asset('plugins/stimulsoft/scripts/id.xml') }}", true);
        ...
        report.loadFile("{{ asset('plugins/stimulsoft/reports/sertifikat/template1.mrt') }}");
