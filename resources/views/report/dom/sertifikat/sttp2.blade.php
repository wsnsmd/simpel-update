...
<head>
    ...
    <style>
        ...
        #tt4 {
            position: fixed;
            bottom: {{ $sertPeserta->spesimen2_bawah }}cm;
            left: {{ $sertPeserta->spesimen2_kiri }}cm;
        }
        @endif
    </style>
</head>
    ...
    <div id="container2">
        ...
        <div id="tt3">
            <table cellspacing="0" cellpadding="0" class="mdiklat">
                ...
                <tr>
                    <td>{!! $sertifikat->jabatan2 !!}</td>
                </tr>
                <tr>
                    <td  style="padding-bottom: 80px">&nbsp;</td>
                </tr>
                <tr>
                    <td>{!! $sertifikat->nama2 !!}</td>
                </tr>
                <tr>
                    <td>{!! $sertifikat->pangkat2 !!}</td>
                </tr>
                <tr>
                    <td>NIP. {!! formatNIP($sertifikat->nip2) !!}</td>
                </tr>
            </table>
            @if(!is_null($sertifikat->spesimen2))
            <div id="tt4">
