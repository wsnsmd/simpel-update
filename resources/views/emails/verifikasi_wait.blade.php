                ...
                <tr>
                  <td class="template-email-content">
                    ...
                    <p class="template-email-text" style="mso-line-height: exactly; line-height: 25px;">
                      ...
                      <strong>{{ $jadwal_tipe }} {{ $jadwal_nama }}</strong> <br />
                      pada tanggal <strong>{{ $jadwal_tgl_awal}}</strong> s/d <strong>{{ $jadwal_tgl_akhir}}</strong> <br />
                      anda sedang direview oleh <strong>BPSDM Prov. Kaltim</strong>
                      <!--[if mso]></span><![endif]-->
                    </p>
                    <p class="template-email-text" style="mso-line-height: exactly; line-height: 25px;">
                      Untuk melihat status peserta anda, bisa diklik tombol dibawah ini.
                    </p>
                  </td>
                </tr>
                <tr>
                            ...
                            <table cellspacing="0" cellpadding="0">
                              <tr>
                                <td align="center" width="174" height="36" bgcolor="#32a0e8"
                                  ...
                                  <a href="{{ $url }}" class="template-email-blue-action-button"
