                ...
                <tr>
                  <td class="template-email-content">
                    ...
                    <p class="template-email-text" style="mso-line-height: exactly; line-height: 25px;">
                      <!--[if mso]><span style="font-family: sans-serif;"><![endif]-->
                      Berikut kami kirim tautan untuk daftar hadir <strong>{{ $jadwal_tipe }} {{ $jadwal_nama }}</strong> tanggal <strong>{{ $jadwal_tanggal }}</strong>.
                      Daftar hadir akan kami <strong>buka</strong> dan <strong>informasikan</strong> oleh Admin pada saat kegiatan berlangsung.
                      <!--[if mso]></span><![endif]-->
                    </p>
                    <p class="template-email-text" style="mso-line-height: exactly; line-height: 25px;">
                      Dan cukup klik tombol Hadir dibawah untuk memastikan kehadiran anda.
                    </p>
                  </td>
                </tr>
                <tr>
                              ...
                              <tr>
                                <td align="center" width="174" height="36" bgcolor="#32a0e8"
                                  ...
                                  <a href="{{ $konfirmasi_url }}" class="template-email-blue-action-button"
                                    style="font-size:16px; font-weight: 600; font-family: 'Ubuntu', sans-serif; text-decoration: none; line-height:36px; width:100%; letter-spacing: -0.22px;display:inline-block">
